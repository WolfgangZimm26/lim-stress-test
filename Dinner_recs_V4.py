...
import time
import random
# Version Info: This version builds on version 3 by incorporating exponential backoff into the function in step 2
# Step 1: Create List of prompts
prompt = "What is the best meal for dinner?"
...
def get_openai_responses(prompt, num_responses=40, max_tokens=100, initial_delay: float = 1,
    ...
    while len(responses) < num_responses and retries < max_retries:
        try:
            ...
            delay *= exponential_base * (1 + jitter * random.random()) #implementation of exponetial backing off
